...
public class StackBenchmark {
    ...
    @Benchmark
    public Stack<Integer> testConstructorDefault() {
        return new Stack<>();
    }
    ...
    private static void writeCustomCsv(Collection<RunResult> results) {
        try (FileWriter writer = new FileWriter("Stack_jmh_performance.csv")) {
            ...
            System.out.println("JMH Performance report saved: Stack_jmh_performance.csv");
        } catch (IOException e) {
